  ...
  const criteriosFLACC = {
    facial: {
      ...
      opciones: [
        {
          valor: 0,
          descripcion: "Expresión neutra no sonríe",
          texto: "Cara relajada",
        },
        {
          valor: 1,
          descripcion: "Mirada triste, expresión preocupada, retraído",
          texto: "Ocasionalmente hace muecas",
        },
        {
          valor: 2,
          descripcion: "Mandíbula apretada, le tiembla el mentón",
          texto: "Frunce el seño con frecuencia",
        },
      ],
    },
    piernas: {
  ...
  return (
    <div class="max-w-6xl mx-auto">
      ...
      <div class="mb-6 flex flex-col items-center justify-center">
        <h1 class="mt-10 text-3xl font-bold text-purple-800 mb-2">
          Escala FLACC
        </h1>
      ...
      <div class="bg-transparent  rounded-xl shadow-lg p-8">
        ...
        <div class="mb-8 border border-gray-500 rounded-lg p-6">
          <div class="inline-flex gap-2 items-center px-4 py-2 bg-purple-300 text-purple-800 rounded-full text-sm font-medium mb-4">
            <CircleCheck />
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                {criterio.opciones.map((opcion) => (
                  <button
                    ...
                    class={`p-4 rounded-lg border-2 border-gray-500 text-left transition-all duration-200 hover:shadow-md ${getColorClase(
                      key,
                      opcion.valor
                    )}`}
                  >
                    <div class="flex items-start mb-2">
                      <div
                        class={`w-6 h-6 rounded-full border-2 border-gray-400 flex items-center justify-center mr-3 shrink-0 ${
