      ...
      <div className='space-y-6'>
        ...
        <div className='flex justify-center space-x-4 pt-6'>
          <button
            ...
            className='px-6 py-3 bg-gray-600 text-white rounded-lg font-medium hover:bg-gray-700 transition-colors duration-200 shadow-sm'
          >
            Nueva Evaluación
          </button>
          {nivelSedacion !== null && (
        ...
        <footer className='text-center text-gray-500 text-sm mt-8'>
          <p>
            <strong>Escala de Ramsay</strong> - Evaluación del nivel de sedación
          </p>
