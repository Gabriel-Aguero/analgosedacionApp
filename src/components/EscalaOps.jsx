  ...
  return (
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-6 flex flex-col items-center justify-center gap-2">
        <h1 class="mt-10 text-3xl font-bold text-blue-800 mb-2">
      ...
      <div class="bg-transparent rounded-xl shadow-lg p-6">
        {/* Instrucciones */}
        <div class="mb-8 border border-gray-500 rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {Object.entries(criteriosOPS).map(([key, criterio]) => (
            <div
              key={key}
              class="border border-gray-500 bg-white rounded-lg p-6 hover:shadow-md transition-shadow"
            >
        ...
        {mostrarResultado && nivelDolor && (
          <div
            class={`mt-8 bg-linear-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200 transition-all duration-500 ease-in-out ${
              mostrarResultado
        ...
        {/* Botones de acción */}
        <div class="flex flex-col justify-center gap-4 items-center mt-8 pt-6 border-t border-gray-200">
          ...
          <div class="flex items-center justify-center gap-4">
            ...
            {todosCriteriosCompletados && (
              <button
                ...
                class="inline-flex items-center px-4 gap-2 py-2 bg-blue-600 text-gray-100 font-bold rounded-lg hover:bg-blue-800 transition-colors duration-200"
              >
                Imprimir Reporte
              </button>
            )}
