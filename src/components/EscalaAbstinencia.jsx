...
const EscalaAbstinencia = () => {
  ...
  return (
    <div class="max-w-7xl mx-auto">
      ...
      <div class="bg-transparent rounded-xl shadow-lg p-6">
        {/* Instrucciones */}
        <div class="mb-8 border border-gray-500 bg-white rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Object.entries(criteriosAbstinencia).map(([key, criterio]) => (
            <div
              key={key}
              class="border-2 border-gray-500 bg-white rounded-lg p-6 hover:shadow-md transition-shadow"
            >
              ...
              <div class="space-y-3">
                {criterio.opciones.map((opcion) => (
                  <button
                    ...
                    class={`w-full p-4 rounded-lg border-2 border-gray-500 text-left transition-all duration-200 hover:scale-[1.02] ${getColorClase(
                      key,
                      opcion.valor
                    )}`}
                  >
                    <div class="flex items-start">
                      <span class="text-2xl mr-3 shrink-0">{opcion.icono}</span>
                      <div class="flex-1">
        ...
        {mostrarResultado && nivelAbstinencia && (
          <div
            class={`mt-8 bg-linear-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200 transition-all duration-500 ease-in-out ${
              mostrarResultado
            ...
            <div class="text-center">
              ...
              <div class="bg-white rounded-lg p-6 border shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-800 mb-3 flex gap-2 items-center">
                ...
                <div class="mt-6">
                  ...
                  <div class="h-3 bg-linear-to-r from-green-400 via-yellow-400 to-red-500 rounded-full relative">
                    <div
        ...
        {/* Botones de acción */}
        <div class="flex flex-col justify-center gap-4 items-center mt-8 pt-6">
          ...
          <div class="flex gap-2 items-center justify-center">
            <button
              ...
              class="inline-flex items-center px-4 gap-2 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors duration-200"
            >
              <Refresh />
              Nueva Evaluación
            </button>
            ...
            {todosCriteriosCompletados && (
              <button
                ...
                class="inline-flex items-center px-4 gap-2 py-2 bg-purple-600 text-gray-100 font-bold rounded-lg hover:bg-purple-800 transition-colors duration-200"
              >
                Imprimir Reporte
              </button>
            )}
